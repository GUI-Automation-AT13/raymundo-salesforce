...
import static utils.LoadEnvironmentFile.dotenv;
...
public class CaseTests {
  ...
  public void LoginWithValidCredentials() {
    driver.get(dotenv.get("BASE_URL_CASE"));
    driver.findElement(By.id("username")).sendKeys(dotenv.get("SALESFORCE_USERNAME"));
    driver.findElement(By.id("password")).sendKeys(dotenv.get("SALESFORCE_PASSWORD"));
